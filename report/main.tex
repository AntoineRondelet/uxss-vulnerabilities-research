...
The following steps in the attack exploit the fact that service worker can intercept requests and can replay them. If we manage to insert malicious data in these replayed requests, then our attack would be successful.

-- Follow on explaining the code that I wrote for the service worker, (the one extracted from stackoverflow and explain that i wanted to modify the request before replaying it)
